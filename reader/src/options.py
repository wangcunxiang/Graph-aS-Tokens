...
class Options():
    ...
    def add_reader_options(self):
        ...
        self.parser.add_argument('--nodes_edges_file', type=str, default='none', help='path of nodes and edges data')
        ...
        self.parser.add_argument('--graph_maxlength', type=int, default=125,
                                 help='maximum number of tokens in an amr graph')
        self.parser.add_argument('--word_maxlength', type=int, default=7,
        ...
        self.parser.add_argument('--no_relation', action='store_true',
                                 help='not to use relations')
        self.parser.add_argument('--text_graph_decoder_layer_stack', action='store_true')
        self.parser.add_argument('--decoder_combination', type=str, default='none',
                                 help='the combination method of text decoder and graph decoder')
        self.parser.add_argument('--graph_as_token', action='store_true')
